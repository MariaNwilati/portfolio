      ...
      >
        ...
        <motion.div variants={cardVariants} className="flex justify-center gap-4 text-center mb-5">
          {languages.map((lang, index) => (
            <motion.span
              key={lang.name}
              className="px-5 py-2.5 rounded-full border border-pink-200/50 dark:border-gray-700/30 text-gray-600 dark:text-gray-300 text-sm font-medium bg-white dark:bg-gray-800/60"
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-6">
                  <span className="w-10 h-10 bg-white dark:bg-gray-700 rounded-lg flex items-center justify-center text-pink-500 dark:text-gray-300 border border-pink-200/50 dark:border-gray-600">
                    {category.icon}
                  </span>
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill, skillIndex) => (
                    <motion.span
                      key={skill}
                      className="px-4 py-2 text-gray-600 dark:text-gray-300 text-sm rounded-full border border-pink-200/50 dark:border-gray-600 hover:border-pink-400 dark:hover:border-pink-500 transition-colors duration-200 cursor-default bg-white dark:bg-gray-700/50"
