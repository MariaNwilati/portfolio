  ...
  return (
    <section id="contact" className="section-padding relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          className="absolute top-0 left-0 w-96 h-96 bg-pink-900/20 bg-pink-900/20 rounded-full blur-3xl"
          animate={{ x: [0, 50, 0], y: [0, 30, 0] }}
          transition={{ duration: 10, repeat: Infinity }}
        />
        <motion.div
          className="absolute bottom-0 right-0 w-80 h-80 bg-rose-900/20 bg-rose-900/20 rounded-full blur-3xl"
