      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-4">
            <span className="text-gray-800 dark:text-white">My </span><span className="text-gradient">Education</span>
          </h2>
          <motion.div
        ...
        <motion.div variants={itemVariants} className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-pink-500 dark:text-pink-400 font-semibold text-lg mb-4">
